...
#ifndef FACTORY_PATTERN_CPP_INCLUDE_HIGH_QUALITY_EXPORTER_H_
#define FACTORY_PATTERN_CPP_INCLUDE_HIGH_QUALITY_EXPORTER_H_
#include <memory>
...
#endif//FACTORY_PATTERN_CPP_INCLUDE_HIGH_QUALITY_EXPORTER_H_
